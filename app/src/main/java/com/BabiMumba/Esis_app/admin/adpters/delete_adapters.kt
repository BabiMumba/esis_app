...
class delete_adapters (options: FirestoreRecyclerOptions<modeluser>):FirestoreRecyclerAdapter<modeluser,delete_adapters.viewholder>(options) {
    ...
    override fun onBindViewHolder(holder: delete_adapters.viewholder, position: Int, model: modeluser) {
