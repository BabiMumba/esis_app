...
class commentaire_adapters (options:FirebaseRecyclerOptions<commentaire_model>):FirebaseRecyclerAdapter<commentaire_model, commentaire_adapters.viewholder>(options){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewholder {
        val v =LayoutInflater.from(parent.context).inflate(R.layout.item_comment2,parent,false)
        return viewholder(v)
    }

    override fun onBindViewHolder(holder: viewholder, position: Int, model: commentaire_model) {
